...
<div class="container-fluid">
	<form action="" id="manage-designation">
		...
		<div class="form-group">
			<label for="description" class="control-label">Descripición</label>
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Cargo ya Existe.</div>')
						end_load()
					}
				}
			})
