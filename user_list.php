	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-success" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Nuevo Usuario</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("Seguro de eliminar usuario?","delete_user",[$(this).attr('data-id')])
	})
	})
