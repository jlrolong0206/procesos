...
<div class="container-fluid">
	<form action="" id="manage-department">
		...
		<div class="form-group">
			<label for="department" class="control-label">Dependecia</label>
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						...
						$('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Dependecia ya Existe.</div>')
						end_load()
					}
				}
			})
