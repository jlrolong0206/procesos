...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Nueva Supervisión</h1>
          </div><!-- /.col -->
		...
		<div class="card-body">
			<form action="" id="manage_evaluation">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="task_id" id="task_id" class="form-control form-control-sm" required>
								<option value="" disabled="" selected="">Porfavor Seleccione el Proceso</option>
							</select>
						</div>
						<div class="row " id="ratings-field" style="display: none">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Eficencia</label>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="" class="control-label">Exactitud</label>
					...
					<div class="col-md-6">
						<div id="post-field">
							<div><center><i>Seleccionar Proceso</i></center></div>
						</div>
					</div>
				</div>
				<hr>
...
<div id="clone_progress" class="d-none">
	<div class="post">
              <div class="user-block">
                <img class="img-circle img-bordered-sm avatar" src="" alt="Usuario">
                <span class="username">
                  <a href="#" class="nf"></a>
                </span>
