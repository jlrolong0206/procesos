	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-success new_designation" href="javascript:void(0)"><i class="fa fa-plus"></i> Nuevo Cargo</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.manage_designation').click(function(){
			uni_modal("Actualización Cargo","manage_designation.php?id="+$(this).attr('data-id'))
		})
	$('.delete_designation').click(function(){
	_conf("Seguro de eliminar Cargo?","delete_designation",[$(this).attr('data-id')])
	})
	})
